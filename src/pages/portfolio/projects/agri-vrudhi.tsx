...
const AgriVrudhi = () => {
  ...
  return (
    <Wrapper>
      ...
      <div id="smooth-wrapper-agri">
        <div id="smooth-content-agri"> 
          <main>
                        ...
                        <div className="project-details-1-right-wrap">
                           <div className="project-details-1-right p-relative">
                              <div className="project-details-1-title-box">
                                 <span className="project-details-1-subtitle"><i>01</i>Ecommerce</span>
                                 <h4 className="project-details-1-title">Agri Vrudhi</h4>
